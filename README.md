...
For a detailed explanation on Sequential Convexification, see the SCvx section (p. 31) of the following reference, on which the implementation is based: [pdf](https://arxiv.org/abs/2106.09125)
Implemented as part of the Planning and Decision Making for Autonomous Robots course at ETH Zurich
